...
public class BioOntologyConfig {
	private static Logger logger = Logger.getLogger(BioOntologyConfig.class);
	...
	public static String getPrefix(String prop) {
		String ns = BioOntologyConfig.getNS(prop);
		String url = BioOntologyConfig.getURL(prop);
